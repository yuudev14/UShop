...
route.post(
  "/get-popular-shops-product/:start",
  ushop.getShopsPopularProductList
);
route.post("/get-latest-shops-product/:start", ushop.getShopsLatestProductList);
route.post(
  "/get-top-sales-shops-product/:start",
  ushop.getShopsTopSalesProductList
);
...
route.post(
  "/get-popular-category-product/:start",
  ushop.getPopularCategoryProducts
);
route.post(
  "/get-latest-category-product/:start",
  ushop.getLatestCategoryProducts
);
route.post(
  "/get-top-sales-category-product/:start",
  ushop.getTopSalesCategoryProducts
);
