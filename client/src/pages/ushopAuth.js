                ...
                <div className='overlay_container'>
                    <div className='overlay'>
                        <div className='overlay_div login_overlay'>
                            ...
                            <button onClick={() => AuthContainer.current.classList.remove('AuthContainerActive')}>login</button>
                        </div>
                        <div className='overlay_div signup_overlay'>
                            <h1>Hello Friend</h1>
                            <p>Enter your personal details and start selling with us</p>
                            <button onClick={() => AuthContainer.current.classList.add('AuthContainerActive')} >signup</button>
                        </div>
